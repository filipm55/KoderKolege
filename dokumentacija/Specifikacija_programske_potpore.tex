...
\eject 
			...
			\subsection{Obrasci uporabe}			
				...
				\subsubsection{Opis obrazaca uporabe}
					...
					\noindent \underbar{\textbf{UC4 - Pregled rezultata natjecanja}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC5 - Pregled rang liste natjecanja}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC6 - Pregled rješenja sudionika natjecanja}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC7 - Pregled kalendara}}
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Otvara se stranica sa prikazom mjesečnog kalendara u kojem su označena natjecanja
					...
					\noindent \underbar{\textbf{UC8 - Pregled profila korisnika}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC9 - Pregled profila natjecatelja}}
					\begin{packed_item}
					...
					\end{packed_item}
						...
						\noindent \underbar{\textbf{UC10 - Pregled profila voditelja}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC11 - Sudjelovanje u natjecanju}}
					\begin{packed_item}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Korisnik odabire opciju Odabir prošlog natjecanja
							\item Otvara se kalendar 
							\item Korisnik bira natjecanje
							\item Korisnik se po završetku natjecanja rangira u odnosu na službene retultate originalnog natjecanja
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Korisniku se po završetku natjecanja prikazuje broj bodova koji je ostvario
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							\item UC10 - Pregled profila voditelja
					...
					\noindent \underbar{\textbf{UC19 - Uređivanje svih natjecanja/zadataka}}
						\begin{packed_item}
							...
							\item \textbf{Glavni sudionik: } Administrator
							\item  \textbf{Cilj:} Ispravljanje grešaka ili nesporazuma u natjecanju/zadatku
							\item  \textbf{Sudionici:} Baza podataka
							\item  \textbf{Preduvjet:} korisnik je prijavljen kao administrator
							\item  \textbf{Opis osnovnog tijeka:}
