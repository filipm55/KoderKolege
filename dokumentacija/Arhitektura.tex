...
\end{longtblr}
		...
		\begin{longtblr}[
			...
			\subsection{Dijagram baze podataka}
				...
				\noindent {Prikazani ER dijgram baze podataka na slici \ref{fig:erdijagram} sadrži vizualne slike ključeva: zlatni ključ predstavlja primarni ključ, a srebrni predstavlja strani ključ, broj 1 predstavlja alternativni ključ. Također prvi redak predstavlja vidljivost tablice u bazi podataka, drugi redak je ime tablice te ostatak su atributi.
				}\\
					\begin{figure}[H]
					\includegraphics[scale=0.1]{slike/Er dijagram baze}
