	...
	\end{itemize}
			...
			\subsection{Opis tablica}
				...
				\begin{longtblr}[
					...
					\hline \SetCell[c=3]{c}{\textbf{Korisnik}}	 \\ \hline[3pt]
					 ...
					 \SetCell{LightBlue}confirmation-hash & VARCHAR & individualni sažetak za registraciju \\ \hline
		...
		\begin{longtblr}[
				...
				\begin{longtblr}[
					...
					\hline \SetCell[c=3]{c}{\textbf{Predaje natjecanja}}	 \\ \hline[3pt]
					\SetCell{LightGreen} id & INT	& jedinstveni identifikator predanog natjecanja \\ \hline
				...
				\begin{longtblr}[
					...
					\hline \SetCell[c=3]{c}{\textbf{Plasman}}	 \\ \hline[3pt]
					\SetCell{LightBlue} id natjecatelja& INT & identifikator natjecatelja	\\ \hline
